            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-sm-7 Banner__Leti__title">
                        ...
                        <h3>Esta es la unidad que se encrarga de desarrollar la gama de productos que abarca diferentes áreas terapéuticas: cardiovascular, metabolismo, gástrica, respiratoria, neurológicas, músculo-esqueléticas, dolor, antibióticos, vitaminas, tanto para el paciente pediátrico como para el paciente adulto.</h3>
                    </div>
