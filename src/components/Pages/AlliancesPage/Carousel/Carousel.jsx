                                ...
                                <div className="row justify-content-center align-items-center Carousel__Alliances__alone">
                                    {getData.map(el =>
                                        <div className="col-4 d-flex justify-content-center">
                                            <img src={el.picPath} onError="this.src = 'https://firebasestorage.googleapis.com/v0/b/grupoleti.appspot.com/o/images%2Fno-image.png?alt=media&token=6e518b16-dc11-46e3-83e8-ae4b84a18293';" alt="" />
                                        </div>
                                    )}
                                </div>
                            </div>
