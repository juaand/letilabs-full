                                    ...
                                    <div className="col-sm-4 col-12">
                                        <div className="card AdminNewsPage__card">
                                            <div className="card-body card-body-img">
                                                <img src={el?.urlToPic} className="AdminNewsPage__img-top" onError="this.src = 'https://firebasestorage.googleapis.com/v0/b/grupoleti.appspot.com/o/images%2Fno-image.png?alt=media&token=6e518b16-dc11-46e3-83e8-ae4b84a18293';" alt={el?.title} />
