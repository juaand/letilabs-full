                    ...
                    <div className="row">
                        <div className="col-12 col-sm-7 Banner__Leti__title">
                            <Fade triggerOnce duration={600}>
                                <img className="Banner__Leti-logo" src={bannerData?.logoURL} onError="this.src = 'https://firebasestorage.googleapis.com/v0/b/grupoleti.appspot.com/o/images%2Fno-image.png?alt=media&token=6e518b16-dc11-46e3-83e8-ae4b84a18293';" alt="Leti" />
                            </Fade>
