...
import {getBannerAlliances, updateBannerAlliances, createContent} from '../../../../../services/ApiClient'
...
function EditBannerAlliances() {
    ...
    const updateBanner = async (event) => {
        ...
        if (Object.values(error).map(el => el).includes(false)) {
            try {
                await updateBannerAlliances(data)
                    .then(banner => {
...
export default EditBannerAlliances
